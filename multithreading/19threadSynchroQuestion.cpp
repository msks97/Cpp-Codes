...
//question you have a string, a char count, a thread count and from string it should take char according to thread count and place it in each thread(number of threads are threead count)

//eg: string "abcdefg" charCount = 3 threadCount=4 so we want output as t1=abc, t2=def, t3=gab ,t4=cde
